      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          >
            <ul>
              <li>
                <Image src={Home} className={styles.img} alt="home" />
                <Link href="/">صفحه اصلی</Link>
              </li>
              <li>
                <Image src={Air} className={styles.img} alt="services" />
                <Link href="/services">خدمات گردشگری</Link>
              </li>
              <li>
                <Image src={Volume} className={styles.img} alt="about" />
                <Link href="/about">درباره ما</Link>
              </li>
              <li>
                <Image src={Call} className={styles.img} alt="contact" />
